...
public class SimilarityStream {
    ...
    public SimilarityStream(StreamExecutionEnvironment env, String sourceName, Time tumblingSize, Time activeWindow, boolean includePosts ){
