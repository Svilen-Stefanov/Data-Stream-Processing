...
public class RecommendLikeTumblingAggregateFunction implements AggregateFunction<LikeEvent,
    ...
    @Override
    public HashMap<Long, Tuple2<Float[], Integer>> add(LikeEvent likeEvent, HashMap<Long, Tuple2<Float[], Integer>> activeUsers) {
        ...
        activeUsers.put(likeEvent.getPersonId(), new Tuple2<>(dynamicSimilarity, 1));
        return activeUsers;
    }
