...
public class RecommendPostTumblingAggregateFunction implements AggregateFunction<PostEvent,
    ...
    @Override
    public HashMap<Long, Tuple2<Float[], Integer>> add(PostEvent postEvent, HashMap<Long, Tuple2<Float[], Integer>> activeUsers) {
        ...
        activeUsers.put(postEvent.getPersonId(), new Tuple2<>(dynamicSimilarity, 1));
        return activeUsers;
    }
